...
**Exercise:** 
- Select all flights with departure delay of more than 30 minutes.
- Find the flight with the longest (maximum) departure delay.
...
**Exercise:**
- find the 5 destinations that are furthest from NY by sorting destination distance in descending order (`desc()`)
